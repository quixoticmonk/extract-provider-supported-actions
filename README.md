...
```json
{
  ...
  "scaleway": [
    ...
    "scaleway_cockpit_grafana_sync_data_sources",
    "scaleway_cockpit_trigger_test_alert",
    "scaleway_iam_update_saml_configuration",
...
```json
{
  ...
  "awscc": [
    ...
    "awscc_chime_sip_media_application",
    ...
    "awscc_redshift_snapshot_copy_grant",
    "awscc_redshift_snapshot_schedule",
    "awscc_redshift_usage_limit",
    ...
    "awscc_transcribe_call_analytics_category",
    "awscc_transcribe_vocabulary",
